...
namespace MT.OnlineRestaurant.DataLayer.Context
{
    ...
    public partial class OrderManagementContext : DbContext
    {
        ...
        public virtual DbSet<TblCartItems> TblCartItems { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblCartItems>(entity =>
            {
                ...
                entity.Property(e => e.TblCartMasterId)
                    .HasColumnName("tblCartMasterID")
                    .HasDefaultValueSql("((0))");
                ...
                entity.Property(e => e.IsItemAvailable)
                    .HasColumnName("IsItemAvailable")
                    .HasColumnType("bit")
                    .HasDefaultValueSql("((0))");

                entity.HasOne(d => d.TblCartMaster)
                    .WithMany(p => p.TblCartItems)
                    .HasForeignKey(d => d.TblCartMasterId)
                    .HasConstraintName("FK_tblCartDetails_tblFoodOrderID");
            });
