    ...
    public partial class Initial_Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblCartMaster", x => x.ID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tblCartMasterID = table.Column<int>(nullable: false, defaultValueSql: "((0))"),
                    IsItemAvailable = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "((0))"),
                    RecordTimeStampCreated = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tblCartDetails_tblFoodOrderID",
                        column: x => x.tblCartMasterID,
                        principalTable: "tblCartMaster",
                        principalColumn: "ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tblCartItems_tblCartMasterID",
                table: "tblCartItems",
                column: "tblCartMasterID");
