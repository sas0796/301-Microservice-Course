...
namespace MT.OnlineRestaurant.DataLayer.Migrations
{
    ...
    [Migration("20200602072649_Initial_Migration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MT.OnlineRestaurant.DataLayer.Context.TblCartItems", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
                    ...
                    b.Property<bool>("IsItemAvailable")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<int>("TblCartMasterId")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("TblCartMasterId");

                    b.ToTable("tblCartItems");
                });

            modelBuilder.Entity("MT.OnlineRestaurant.DataLayer.Context.TblCartMaster", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ID")
            ...
            modelBuilder.Entity("MT.OnlineRestaurant.DataLayer.Context.TblCartItems", b =>
                {
                    b.HasOne("MT.OnlineRestaurant.DataLayer.Context.TblCartMaster", "TblCartMaster")
                        .WithMany("TblCartItems")
                        .HasForeignKey("TblCartMasterId")
